      ...
      <div style={{ borderBottom: "1px solid var(--line)", background: "var(--surface)" }}>
        <div style={{ maxWidth: 1160, margin: "0 auto", padding: "0 40px" }}>
          <div style={{ padding: "64px 0 56px" }}>
            <div style={{ fontSize: 13, color: "var(--text-muted)", marginBottom: 16 }}>Warranty</div>
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 64, alignItems: "end" }}>
              ...
              <p style={{ fontSize: 16, color: "var(--text-muted)", lineHeight: 1.45, maxWidth: "44ch", paddingBottom: 4 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)" }}>
            {[
              ...
              <div key={item.label} style={{
                ...
                <div style={{ fontFamily: "var(--font-display)", fontSize: "var(--t-numeral)", fontWeight: 400, lineHeight: 1, letterSpacing: "-0.01em", color: i === 0 ? "var(--gold)" : "var(--text)", marginBottom: "var(--s-2)" }}>
                  {item.value}
                </div>
                <div style={{ fontSize: "var(--t-label)", fontFamily: "var(--font-body)", fontWeight: 700, letterSpacing: "0.08em", textTransform: "uppercase", color: "var(--text-muted)" }}>
                  {item.label}
                </div>
              </div>
            ))}
            ...
            {SECTIONS.map((section, i) => (
              <div key={section.heading} style={{
                ...
                <h2 style={{
                  ...
                  color: "var(--text)", marginBottom: 18, lineHeight: 1.3,
                }}>
                  {section.heading}
                </h2>
                {section.body.map((para, j) => (
                  <p key={j} style={{
                    fontSize: 16, lineHeight: 1.45, color: "var(--text-muted)",
      ...
      <div style={{ background: "var(--surface)", borderTop: "1px solid var(--line)" }}>
        <div style={{ maxWidth: 1160, margin: "0 auto", padding: "0 40px" }}>
          <div style={{ padding: "56px 0", display: "flex", alignItems: "center", justifyContent: "space-between", gap: 40, flexWrap: "wrap" }}>
            <div>
              <p style={{ fontFamily: "var(--font-display)", fontSize: 26, color: "var(--text)", marginBottom: 10, fontWeight: 400 }}>
