    ...
    <div>
      ...
      <section style={{ position: "relative", height: 560, overflow: "hidden" }}>
        ...
        <img
          ...
          alt="Modern kitchen remodel - US Floor Design Center"
        ...
        <div style={{
          ...
          <div style={{ maxWidth: 1160, margin: "0 auto", padding: "0 40px 56px", width: "100%" }}>
            <p style={{ fontSize: 12, color: "rgba(241,238,231,0.7)", textTransform: "uppercase", letterSpacing: "0.1em", marginBottom: 10 }}>
              Featured project
            </p>
            <p style={{ fontFamily: "var(--pub-serif)", fontSize: 32, color: "#F1EEE7", lineHeight: 1.2, marginBottom: 20, maxWidth: "18ch" }}>
              Modern kitchen. Oak, stone, and open light.
            </p>
            <Link href="/request-a-visit" style={{
              display: "inline-block", background: "var(--pub-stone)", color: "var(--pub-forest)",
