      ...
      <div style={{ display: "grid", gridTemplateColumns: "0.6fr 1.4fr", gap: 80, padding: "72px 0 0" }}>
        ...
        <div style={{ paddingTop: 8 }}>
          ...
          <h1 style={{
            ...
            lineHeight: 1.25, color: "var(--text)", marginBottom: 20, maxWidth: "12ch",
          }}>
            Tell us about your project.
          </h1>
          <p style={{ fontSize: 15, color: "var(--text-muted)", lineHeight: 1.45, maxWidth: "30ch" }}>
          ...
          <div style={{ marginTop: 32, borderTop: "1px solid var(--line)", paddingTop: 24 }}>
            {[
              ...
              <div key={item.text} style={{ display: "flex", gap: 10, marginBottom: 10, fontSize: 13, color: "var(--text-muted)" }}>
                <span style={{ color: "var(--red)", fontWeight: 600 }}>{item.icon}</span>
                {item.text}
              </div>
            ))}
          </div>
