...
export const metadata = {
  ...
  description: "Design-build for medical and dental offices across South Orange County, from pre-construction and design through delivery and warranty.",
};
      ...
      <div style={{ borderBottom: "1px solid var(--line)", background: "var(--surface-alt)" }}>
        <div style={{ maxWidth: "var(--container)", margin: "0 auto", padding: "0 var(--gutter)" }}>
          <div style={{ padding: "var(--s-9) 0 var(--s-8)" }}>
            ...
            <h1 style={{ fontFamily: "var(--font-display)", fontWeight: 400, fontSize: "var(--t-h1)", lineHeight: 1.10, letterSpacing: "-0.01em", color: "var(--text)", marginBottom: "var(--s-4)" }}>Medical Offices</h1>
            <p style={{ fontSize: "var(--t-body-lg)", color: "var(--text-muted)", lineHeight: 1.35, maxWidth: "52ch", margin: 0 }}>Design-build for clinics, dental suites, and healthcare offices.</p>
          </div>
        </div>
      </div>
      <div style={{ background: "var(--surface)" }}>
        <div style={{ maxWidth: "var(--container)", margin: "0 auto", padding: "0 var(--gutter)" }}>
          <div style={{ maxWidth: "68ch", padding: "var(--s-8) 0" }}>
            <p style={{ fontSize: "var(--t-body-lg)", color: "var(--text-muted)", lineHeight: 1.6, marginBottom: "var(--s-7)" }}>We plan, design, and build interior improvements for medical practices, with one point of contact from pre-construction through warranty. Requirements differ by practice and property, so the scope, schedule, and any landlord or association review are confirmed before work begins.</p>
