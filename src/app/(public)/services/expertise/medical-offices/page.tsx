...
export const metadata = {
  title: "Medical Offices | US Floor Design Center",
  description: "Flooring and finish solutions for medical and healthcare office environments.",
};
      ...
      <div style={{ borderBottom: "1px solid var(--line)", background: "var(--surface-alt)" }}>
        <div style={{ maxWidth: "var(--container)", margin: "0 auto", padding: "0 var(--gutter)" }}>
          <div style={{ padding: "var(--s-9) 0 var(--s-8)" }}>
            ...
            <p style={{ fontSize: "var(--t-body-lg)", color: "var(--text-muted)", lineHeight: 1.35, maxWidth: "52ch", margin: 0 }}>Durable, compliant flooring and finishes for healthcare environments.</p>
          </div>
        </div>
      </div>
