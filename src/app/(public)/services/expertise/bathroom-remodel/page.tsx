...
export const metadata = {
  title: "Bathroom Remodel | US Floor Design Center",
  description: "Tile, stone, and surface selections for bathroom remodels in Orange County.",
};
      ...
      <div style={{ borderBottom: "1px solid var(--line)", background: "var(--surface-alt)" }}>
        <div style={{ maxWidth: "var(--container)", margin: "0 auto", padding: "0 var(--gutter)" }}>
          <div style={{ padding: "var(--s-9) 0 var(--s-8)" }}>
            ...
            <p style={{ fontSize: "var(--t-body-lg)", color: "var(--text-muted)", lineHeight: 1.35, maxWidth: "52ch", margin: 0 }}>Tile, stone, and finishes that make your bathroom a better room.</p>
          </div>
        </div>
      </div>
