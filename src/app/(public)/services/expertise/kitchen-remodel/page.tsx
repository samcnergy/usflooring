...
export const metadata = {
  ...
  description: "Kitchen design and construction across South Orange County: cabinetry, countertops, flooring, and layout changes.",
};
      ...
      <div style={{ borderBottom: "1px solid var(--line)", background: "var(--surface-alt)" }}>
        <div style={{ maxWidth: "var(--container)", margin: "0 auto", padding: "0 var(--gutter)" }}>
          <div style={{ padding: "var(--s-9) 0 var(--s-8)" }}>
            ...
            <p style={{ fontSize: "var(--t-body-lg)", color: "var(--text-muted)", lineHeight: 1.35, maxWidth: "52ch", margin: 0 }}>Cabinetry, countertops, flooring, and layout changes, designed and built by one team.</p>
          </div>
        </div>
      </div>
      <div style={{ background: "var(--surface)" }}>
        <div style={{ maxWidth: "var(--container)", margin: "0 auto", padding: "0 var(--gutter)" }}>
          <div style={{ maxWidth: "68ch", padding: "var(--s-8) 0" }}>
            <p style={{ fontSize: "var(--t-body-lg)", color: "var(--text-muted)", lineHeight: 1.6, marginBottom: "var(--s-7)" }}>Kitchen projects start with design and material selection in our design center, then move through pre-construction, installation, and a final walkthrough, with one point of contact the whole way.</p>
