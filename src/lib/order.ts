    ...
    if (input.lineItems.length > 0) {
      await tx.orderLineItem.createMany({
        data: input.lineItems.map((li, i) => ({
          ...
          notes: li.notes,
          showerWallSqft:        li.showerWallSqft,
          showerWallMaterial:    li.showerWallMaterial,
          showerPan:             li.showerPan ?? null,
          showerPanMaterial:     li.showerPanMaterial,
          showerSoapBoxMaterial: li.showerSoapBoxMaterial,
          showerBench:           li.showerBench ?? null,
          bathroomFloorSqft:     li.bathroomFloorSqft,
          ...
          showerTileVertical:    li.showerTileVertical ?? null,
          showerTileHorizontal:  li.showerTileHorizontal ?? null,
          woodWhiteRisers:       li.woodWhiteRisers ?? null,
