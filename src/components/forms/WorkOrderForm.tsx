...
import type { WorkOrderInitialValues, WorkOrderActionState } from "./WorkOrderForm.shared";

// Re-export for client-side import convenience. Server components MUST
// import from "./WorkOrderForm.shared" directly.
export type { WorkOrderInitialValues, WorkOrderActionState } from "./WorkOrderForm.shared";
export { workOrderToInitial } from "./WorkOrderForm.shared";
